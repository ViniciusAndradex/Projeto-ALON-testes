...
Funcionalidade: Testar o campo de Email na página de primeiro acesso do ALon
    ...
    Cenário: acessar a página de primeiro acesso, não inserir nenhum caractere no campo Email e tentar efetuar o login 
        Dado que preenche o campo Email EM BRANCO
