...
Funcionalidade: Testar o campo de Confirmar o Email na página de primeiro acesso do ALon
    ...
    Cenário: acessar a página de primeiro acesso, inserir caracteres válidos no campo Confirmar Email e efetuar o login 
        Dado que preenche o campo Email
        Dado que preenche o campo Confirmar Email VALIDO
