...
Funcionalidade: Testar o campo de Senha na página de primeiro acesso do ALon
    ...
    Cenário: acessar a página de primeiro acesso, inserir caracteres inválidos no campo Senha e tentar efetuar o login 
        Dado que preenche o campo Email
        Dado que preenche o campo Confirmar Email 
        Dado que preenche o campo Senha INVÁLIDO
